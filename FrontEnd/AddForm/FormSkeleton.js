...
const FormSkeleton = ({ title, setTitle, description, setDescription, quesText, setQuesText, optionType, setOptionType, quesValue, setQuesValue, quesValues, setQuesValues, quesList, setQuesList, isModalVisible, setIsModalVisible, CustomCheckbox, CustomRadioButton, optionTypeList, handleTitleChange, handleDescriptionChange, handleQuesText, addQuesValues, handleSaveFormData, handleSaveQuestions, removeItem, handleSubmitOrClose  }) => {
