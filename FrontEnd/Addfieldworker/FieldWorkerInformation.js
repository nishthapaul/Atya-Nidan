...
const FieldWorkerInformation = ({ firstName, middleName, lastName, address, contactNumber, emailId, setfirstName, setmiddleName, setlastName, setAddress, setContactNumber, setEmailId, handleImageUpload, saveModal, handleSubmit, setAadhar, aadhar, setGender, gender, setDateOfBirth, dateofbirth, setRailwayStation, railwaystation, officeaddress, setOfficeAddress, setTaluka, taluka, bloodgroup, setBloodGroup, validateField, errors, setErrors, handleSubmitOrClose, talukaList, setLangKnown3, setLangKnown2, setLangKnown1, lagknown3, lagknown2, lagknown1}) => {
  ...
  return (
        <View>
          ...
          <Text style={styles.headerText}>Add Field Worker</Text>
          ...
          {errors.emailId && <Text style={styles.errorText}>Email must be a Gmail address (example@gmail.com)</Text>}
            ...
            <Text style={styles.sectionHeading}>Office Information</Text>

            <Text style={styles.contacttitle}>Office Address*</Text>
            <TextInput
                    style={[styles.input, styles.inputSpacing, errors.officeaddress ? styles.inputError : null]}
                    value={officeaddress}
                    onChangeText={(offadd) => { setOfficeAddress(offadd);
