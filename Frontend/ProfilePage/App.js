      ...
      <View style={styles.container}>
        ...
        <View style={styles.sidebar}>
          <Image 
            ...
            />
          <Text onPress={() => handleMenuItemClick('Basics')} style={getMenuItemStyle('Basics')}>Basics</Text>
          <Text onPress={() => handleMenuItemClick('Profile Photo')} style={getMenuItemStyle('Profile Photo')}>Profile Photo</Text>
          <TouchableOpacity onPress={() => handleMenuItemClick('Logout')}>
              <Text style={getMenuItemStyle('Logout')}>Logout</Text>
          </TouchableOpacity>
